...
1. **`--probe attributes`** — L6's attributability criterion. The wire half is
   done and tested (`0x003A` carries real triples), but *does the panel show
   ...
   (12/9/6/3/1) so a mis-ordered triple shows the right numbers against the
   wrong names.
