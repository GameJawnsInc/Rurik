...
* **SANDBOX-B6, the owner's first run** through the window: the slice's own spec, then
  ...
  follow and cast), **U3** (a body of another profession carries the declared one) and
  **U4** (a four-strong group pulls as one) — predictions in §3 there.
