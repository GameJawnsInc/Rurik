...
- **R4b — *n* of **9**.** Pre-Searing's reachable skills span nine of the client's 21
  ...
  Flare 194, Healing Signet 1, Sever Artery 382, …). **Today n = 2 of 9 on the episode reading and 0 of 9 on the mechanic reading, 2026-08-20 — and which of those the criterion means is an OWNER RULING this rung now needs.** Stance (Frenzy 346) and Hex (Scourge Sacrifice 253) apply, render, time and expire at the client; no effect's MECHANIC is modelled. §3's R4b row carries both numbers and the argument. Nine and not 21
