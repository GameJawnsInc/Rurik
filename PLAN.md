...
* **ANIMREF-RE §41 (2026-09-03, `47f0cdc`) — "couldn't resume attacking" was
  ...
  first `0x003D` (23.56 s) — five reports, no `0x0047` ever (our grant turned
  the walk into a silent click-order leg; the tap shows the body parked at the
  grant's point from 26.8 s), `kbd_moving_at` armed for 16.6 s, 22 presses
