...
3. ~~**The hero route's remaining blocker**~~ **CLOSED — the hero is authored end to end**
   ...
   crashes**, and `inventoryId` — field 3 of HeroActivate, which we send as 0 — is the named
   suspect. `0x0074`'s other 17 fields are still unexplained.
