...
(That scope follows the handoff top box's own ruling; the explicit owner yes its
decision 1 asked for is not yet recorded — it is the refusing, cheap-to-reverse
direction.) What landed is a rule for NEW tokens only (a registered word prefix naming
...
(`29:`→`42:`) is retired with its meaning recorded, not rewritten.
