...
* **Reconcile §3's R-ISLE row.** It still calls rung 8d (the re-cast shape) OPEN and
  mid-flight as of 2026-08-22, while skills §49.7 (RUN-SKILLS-RB2, 2026-09-17) reads
  both recast shapes off a tape and closes §36.8's "unwitnessed either way". Either the
  row is stale or 8d still asks something RB2 did not; say which, in §3.
