...
| U4 | arc complete on `claude/u4-assembly-resolver`; review returned CONFIRMED-no-bugs with four test gaps (visited-set discrimination, a control that could not fail, the pooled needs_body equivalence, the npcdefs refusal) — fixes in progress before merge |
| U6–U7 | not started; U6 (byte-identical round trip) is next once U4 lands |
