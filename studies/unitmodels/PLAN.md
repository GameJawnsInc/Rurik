...
| U6–U7 | not started. **U6 (byte-identical round trip) is the last rung before the summit** — its precondition (spans tiling on real payloads) is already a U5 check; U7 needs U6 plus an owner-driven loopback client run. |
