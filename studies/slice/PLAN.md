...
| **SLICE-H5** | **Commands.** `0x0015` stance (Fight/Guard/Avoid — engagement on/off), `0x0016` lock target (the hero attacks it), `0x001A` flag (walk there and hold, the follow suspended; `0x001B` party flag for all) — the echoes exist (pvpui 28.6), the behaviour is wired to nothing | TODO |
