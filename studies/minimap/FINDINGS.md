...
| `s_worldData` base **VA `0x00A36210`**, **stride 48**, **10 records** | accessor `0x005A93B0`: `lea eax,[esi+esi*2]; shl eax,4` = ×48; 480 B / 48 = 10 | OBSERVED — **corrects `toolkit/clientscan/consttable.py:539`**, which carries `stride=24, "UNSETTLED"` and prints `20 × 24`; 48 is in its own rival-stride list |
