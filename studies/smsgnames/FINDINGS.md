...
| 0x005D | `CHAT_MESSAGE` | ChCli/table | Delivers an encoded (EncString) wide message string, appended to a growing string table at ctx+0x2c +4 (count +0xc); the same channel that carries level-up templates, /bo |
