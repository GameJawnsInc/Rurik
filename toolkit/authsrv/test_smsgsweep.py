...
# Floor 99, MEASURED from a green run on 2026-08-13 (was 64 before section 9). Sections 0
# and 2-7 and 9 need no vault, no socket and no client -- 94 checks -- because a scoring
...
LEDGER = checks.Ledger("smsgsweep: the loopback sweep's readout", floor=99)
