...
def section_exclusive():
    ...
    # SLICE-F47 (2026-09-16): Rush is a speed stance, so its apply is followed
    ...
    LEDGER.ok(ops == [effects.OP_EFFECT_REMOVE, effects.OP_EFFECT_APPLY,
              ...
              "(then the speed word Rush carries, SLICE-F47)",
...
def section_wire():
    ...
    ep = authsrv.apply_effect(send, state, caster_id=authsrv.PLAYER_AGENT_ID,
                              ...
                              conn_id=0)
    # SLICE-F47: Rush's apply is followed by its 0x0027 (288 x 1.25 = 360);
    ...
    # SLICE-F47: [0x0042, 0x0027 360] then the close [0x0044, 0x0027 288] --
