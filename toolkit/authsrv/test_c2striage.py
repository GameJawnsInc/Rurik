...
if live is not None:
    ...
    # The three named at step 3 are in the census with their reply chains; 0x00B1
    # MAP_TRAVEL still waits for its arm, while 0x009F HENCHMAN_ADD got its arm
    # at step 5 (2026-09-23) and 0x004F/0x0030 at step 8 -- so those must now be
    # HANDLED and off the allowlist.
    for op, nm in ((0x00B1, "MAP_TRAVEL"),):
